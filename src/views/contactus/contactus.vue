    ...
    <div class="contactus-con">
      <div class="contactus-con-up">
        ...
        <div class="contactus-con-link">
          <p>简历投递：http://campus.51job.com/dpark/</p>
          <p>HR 专线：0512-67612670</p>
        </div>
      </div>
      <div class="contactus-con-ud">
        <div class="contactus-type">
            <img class="contactus-type-up" src="../../assets/imgs/socialrecruitment.png" alt="">
            <div class="contactus-type-list" @click="showListone(item.id)" v-for="item in newrequirement" :key="item.id">
                <div class="list-title">
                    <span class="line"></span>
                    <span class="text">{{item.title}}</span>
                    <img v-show="active1!=item.id" class="xiala" src="../../assets/imgs/xiala-r.png" alt="">
                    <div class="xiala1" v-show="active1==item.id" @click="showListone(0)">
                      <img  class="xiala" src="../../assets/imgs/xiala-ud.png" alt="">                      
                    </div>
                </div>
                <div class="list-con" v-show="active1==item.id">
                    ...
                    <li v-for="(item2,index2) of item.responsibility" :key="'info1-'+ index2">{{item2}}</li>
                </div>
            </div>
        </div>
        <div class="contactus-type">
            <img class="contactus-type-up" src="../../assets/imgs/Campusrecruitment.png" alt="">
            <div class="contactus-type-list" @click="showListthree(item.id)" v-for="item in newcampuslist" :key="item.id">
                <div class="list-title">
                    <span class="line"></span>
                    <span class="text">{{item.title}}</span>
                    <img v-show="active3!=item.id" class="xiala" src="../../assets/imgs/xiala-r.png" alt="">
        ...
        <div class="contactus-type">
            <img class="contactus-type-up" src="../../assets/imgs/Internshiphiring.png" alt="">
            <div class="contactus-type-list" @click="showListtwo(item.id)" v-for="item in newinternlist" :key="item.id">
                <div class="list-title">
                    <span class="line"></span>
                    <span class="text">{{item.title}}</span>
                    <img v-show="active2!=item.id" class="xiala" src="../../assets/imgs/xiala-r.png" alt="">
    ...
    <div class="aboutus-map">
      ...
      <div class="aboutus-map-con">
        <div class="aboutus-map-con-l">
          <img src="../../assets/imgs/aboutus-map.png" alt />
        </div>
      ...
      this.$api.get("recruits/social", {}, res => {
        if (res.data.code == 1) {
          ...
          for(let i=0;i<this.sociallist.length;i++){
            ...
            let responsibilitys= this.sociallist[i].responsibility.split("；")
            this.newrequirement.push({requirement:sociallists,responsibility:responsibilitys,title:this.sociallist[i].title,id:this.sociallist[i].id})
      ...
      this.$api.get("recruits/campus", {}, res => {
        if (res.data.code == 1) {
          ...
          for(let i=0;i<this.campuslist.length;i++){
            ...
            let responsibilitys= this.campuslist[i].responsibility.split("；")
            this.newcampuslist.push({requirement:campuslists,responsibility:responsibilitys,title:this.campuslist[i].title,id:this.campuslist[i].id})
      ...
      this.$api.get("recruits/intern", {}, res => {
        if (res.data.code == 1) {
          ...
          for(let i=0;i<this.internlist.length;i++){
            ...
            let responsibilitys= this.internlist[i].responsibility.split("；")
            this.newinternlist.push({requirement:internlists,responsibility:responsibilitys,title:this.internlist[i].title,id:this.internlist[i].id})
